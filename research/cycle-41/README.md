...
Synthetic Closeout.md and Long-notes.md were used. Native checks: spelling Replace/Undo and code exclusion; grammar check; palette navigation; two-page paginated preview; speech Start/Stop invocation; fullscreen Quit/relaunch with two tabs; long-note forward jump after fixing Qt's dropped empty anchor behavior. Return positions covered automatically; final native return click moved preview from 100% to about 2%, with the reference visible at the top. Modeless Writing Review stayed open during typing, updated results, and the sample change was undone.
