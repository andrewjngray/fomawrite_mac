...
The [24 September native iA capture](../menu-audit-2026-09-24/native-submenus.md) supplies Edit submenu labels. The remaining Cycle 54 scope still needs sample-based trigger, IME and Undo observations before substitutions/correction are implemented. Dictation/AutoFill are AppKit-provided and remain OS-dependent.
