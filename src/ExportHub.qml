...
Dialog {
    ...
    background: Rectangle { color: backend.palette.panel; border.color: backend.palette.border; radius: 10 }
    header: Label {
        text: hub.title; leftPadding: 20; rightPadding: 20; topPadding: 16; bottomPadding: 12
        color: backend.palette.text; font.pixelSize: 18; font.weight: Font.DemiBold
        Accessible.role: Accessible.Heading
    }
    contentItem: ColumnLayout {
        spacing: 0
        RowLayout {
            Layout.fillWidth: true; Layout.fillHeight: true; Layout.margins: 16; spacing: 16
            ColumnLayout {
                Layout.preferredWidth: hub.compact ? -1 : 250
                Layout.fillWidth: hub.compact; Layout.fillHeight: hub.compact; spacing: 12
                Label { text: "Output"; color: backend.palette.muted; font.pixelSize: 12; font.weight: Font.DemiBold }
                ComboBox {
                ...
                Label { text: "Style"; color: backend.palette.muted; font.pixelSize: 12; font.weight: Font.DemiBold }
                Label { Layout.fillWidth: true; text: backend.outputTemplateName + " / " + backend.outputFont + " / " + backend.outputPointSize + " pt"; wrapMode: Text.Wrap; color: backend.palette.text; Accessible.name: "Current output style: " + text }
                ...
                Label { text: "Paper"; color: backend.palette.muted; font.pixelSize: 12; font.weight: Font.DemiBold }
                ComboBox {
                ...
                Label { text: "Orientation"; color: backend.palette.muted; font.pixelSize: 12; font.weight: Font.DemiBold }
                RowLayout {
                    Layout.fillWidth: true
                ...
                Button { visible: hub.compact; Layout.fillWidth: true; text: "Paginated Preview…"; onClicked: backend.printPreview(); Accessible.name: "Open paginated print preview" }
            }
            ...
            ColumnLayout {
                ...
                Label { text: "Live output preview"; color: backend.palette.muted; font.pixelSize: 12; font.weight: Font.DemiBold }
                Rectangle {
                ...
                Button { objectName: "exportPaginatedPreviewButton"; text: "Paginated Preview…"; onClicked: backend.printPreview(); Accessible.name: "Open paginated print preview" }
            }
        }
        ...
        RowLayout {
            ...
            Button { objectName: "exportShareMarkdownButton"; text: "Share Markdown…"; onClicked: backend.nativeWindowAction("share"); Accessible.name: "Share Markdown" }
            Item { Layout.fillWidth: true }
            Button { text: "Cancel"; onClicked: hub.close(); Accessible.name: "Cancel export" }
            Button { objectName: "exportDestinationButton"; text: selectedFormat === "pdf" ? "Choose PDF destination…" : "Choose HTML destination…"; highlighted: true; onClicked: { hub.destinationRequested(hub.selectedFormat); hub.close(); } Accessible.name: text }
        }
    }
}
