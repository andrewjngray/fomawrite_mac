...
Dialog {
    ...
    contentItem: Column {
        ...
        Label {
            width: parent.width
            text: root.deleted
                ? "This file was removed outside Fomawrite. Keep your text as an unsaved document?"
                : (root.locallyModified
                   ? "This file changed outside Fomawrite. Reloading will discard your changes."
                   : "This file changed outside Fomawrite.")
