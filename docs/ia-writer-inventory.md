...
**Current menu audit — 24 September 2026:** The 30 files in `screenshots/` have been reviewed against the Cycle 47 baseline. The consolidated [screenshot-backed menu map and current gap audit](ia-menu-audit-2026-09-23.md), updated through combined Cycle 57b/58a source and partial native QA, supersedes the dated command-status descriptions below. Source passes 99 tests; the stable Dev app is refreshed with that source. A [read-only native iA follow-up](../research/menu-audit-2026-09-24/native-submenus.md) captured File/Edit/View PDF, pre-setup Authors, Application, Window and Help children absent from the screenshots. Post-setup authorship and exact substitution behaviors remain unverified. The [sequential closeout plan](menu-closeout-plan.md) schedules Cycles 48–59.
