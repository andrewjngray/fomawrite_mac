...
**Current status — 24 September 2026:** Cycle 51 is the latest fully native-verified build. Current Cycles 52–57a source pass 97 tests; the ordinary app is packaged from Cycle 53 and Dev is refreshed through 57a. Partial native checks cover View/Go/Focus menus, fixture statistics, automatic small-root tags, completion/Undo, Custom and Fillers, the pre-setup Authors sheet, and both bundled offline Help pages. Help page presence and Close/Escape were verified through macOS accessibility, while screenshots, dark/narrow layout, VoiceOver and the OS Help search remain unchecked. Online Support and remaining Window/AppKit behavior remain open. The [iA native menu follow-up](../research/menu-audit-2026-09-24/native-submenus.md) captured previously hidden child labels, but screenshot-based, accessibility and remaining workflow acceptance are open. The Mac 0.2.0 RC1 download remains the Cycle 42 artifact. The [menu closeout plan](menu-closeout-plan.md) starts from the [screenshot audit](ia-menu-audit-2026-09-23.md); older cycle counts below are historical. Full iA Writer parity and hardware acceptance remain open.
