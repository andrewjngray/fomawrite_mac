...
**Current status — 24 September 2026:** Cycle 51 is the latest fully native-verified build. Current Cycles 52–58a source pass 98 tests; the ordinary app is packaged from Cycle 53 and Dev is refreshed through 58a. Partial native checks cover View/Go/Focus menus, fixture statistics, automatic small-root tags, completion/Undo, Custom and Fillers, the pre-setup Authors sheet, both bundled offline Help pages and local heading-fragment routing. For Cycle 58a, Source.md opened by path and Go → Open Link opened Target.md with clean status and no fragment in the title; exact source-caret and preview scrolling are automated only. Visual scrolling and screenshot capture were unavailable. Cross-window fragment transfer and missing-anchor feedback remain open. This is bounded local navigation, not Markdown parser/output parity. Online Support and remaining Window/AppKit behavior also remain open. The [iA native menu follow-up](../research/menu-audit-2026-09-24/native-submenus.md) captured previously hidden child labels, but screenshot-based, accessibility and remaining workflow acceptance are open. The Mac 0.2.0 RC1 download remains the Cycle 42 artifact. The [menu closeout plan](menu-closeout-plan.md) starts from the [screenshot audit](ia-menu-audit-2026-09-23.md); older cycle counts below are historical. Full iA Writer parity and hardware acceptance remain open.
