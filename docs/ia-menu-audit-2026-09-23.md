...
| Transformations | **Partial (Cycles 50b–50c)** | All four captured labels and order appear. Capitalize and Make Title Case are distinct: both reproduce observed iA English samples with one-step Undo. Unobserved locale, punctuation and title-style rules remain open. |
