...
Proposed 25 September 2026 after Cycle 61. This is a plan, not a claim that the features below are implemented. It adds Ulysses and Typora-inspired work to the existing [iA Writer menu backlog](ia-writer-inventory.md) and [release acceptance ledger](release-acceptance.md); the open iA gaps remain open. Cycle numbers are proposed sequential checkpoints and may split into lettered increments when needed.
